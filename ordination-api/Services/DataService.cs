...
public class DataService
{
    ...
    public DagligFast OpretDagligFast(int patientId, int laegemiddelId, 
        ...
        Laegemiddel LM = db.Laegemiddler.FirstOrDefault(l => l.LaegemiddelId == laegemiddelId);
        Patient p = db.Patienter.FirstOrDefault(p => p.PatientId == patientId);
        Dosis MD = new Dosis { antal = antalMorgen};
    ...
    public string AnvendOrdination(int id, Dato dato) {
        ...
        if(checkordination.givDosis(dato) == true){
            ...
            return "Afvist, tjek at ordinationen er inden for gyldig dato";
        }
    }
	...
	public double GetAnbefaletDosisPerDøgn(int patientId, int laegemiddelId) {
        ...
        if(p.vaegt < 25){
            return l.enhedPrKgPrDoegnLet;
        } else if (p.vaegt < 120){
            return l.enhedPrKgPrDoegnNormal;
        } else {
            return l.enhedPrKgPrDoegnTung;
        }
	}
